        ...
        <div class="content">
            ...
            {{ Csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <!--  -->
                    {!! Form::text('email','', ['class'=>"form-control form-control-solid placeholder-no-fix",'placeholder'=>"Username"]) !!}
                   @if ($errors->has('email'))
                                    
                                        <strong style="font-family: cursive;
    color: rgba(230, 62, 64, 0.57);">{{ $errors->first('email') }}</strong>
                    ...
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                     ...
                     {!! Form::password('password',['class'=>"form-control form-control-solid placeholder-no-fix",'placeholder'=>"Password"]) !!}
                      @if ($errors->has('password'))
                                        ...
                                        <strong style="font-family: cursive;color: rgba(230, 62, 64, 0.57);">{{ $errors->first('password') }}</strong>
        ...
        <div class="copyright"> 2017 © Classified All Rights Reserved. </div>
        <!--[if lt IE 9]>
...
$(function() {
 ...
 toastr.error('{{session('msg')}}','Denied');
    })
